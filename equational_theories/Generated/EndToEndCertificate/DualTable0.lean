...
/-! `dualtable` entries 0-1999, where an entry is the duality fact for law index i.
...
shard -- is indexed from 0. Add 0 to get an index into `dualtable`.
-/

namespace EndToEnd

set_option maxRecDepth 20000 in
def dualtable0 : RArray DualFact :=
