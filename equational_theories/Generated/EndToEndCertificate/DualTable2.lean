...
/-! `dualtable` entries 4000-4693, where an entry is the duality fact for law index i.
...
shard -- is indexed from 0. Add 4000 to get an index into `dualtable`.
-/

namespace EndToEnd

set_option maxRecDepth 20000 in
def dualtable2 : RArray DualFact :=
  loadDualTable% "json/dualtable.json" 8681873883473320463
    entries 4000 to 4694
