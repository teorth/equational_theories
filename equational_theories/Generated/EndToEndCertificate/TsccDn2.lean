...
including this shard -- is indexed from 0. Add 1777 to get an index into
`tsccdn`.
-/
...
/-- 626 entries, loaded from `json/sccDn.json`. -/
def tsccdn2 : RArray (List Nat) :=
  loadNatListTable% "json/sccDn.json" 15935514372909340394
    entries 1777 to 2403
