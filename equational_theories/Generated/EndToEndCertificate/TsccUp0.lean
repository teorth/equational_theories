...
including this shard -- is indexed from 0. Add 0 to get an index into
`tsccup`.
-/
...
/-- 1564 entries, loaded from `json/sccUp.json`. -/
def tsccup0 : RArray (List Nat) :=
