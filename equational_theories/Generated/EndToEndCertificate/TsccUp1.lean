...
including this shard -- is indexed from 0. Add 1564 to get an index into
`tsccup`.
-/
...
/-- 1299 entries, loaded from `json/sccUp.json`. -/
def tsccup1 : RArray (List Nat) :=
  loadNatListTable% "json/sccUp.json" 12075438337659712270
    entries 1564 to 2863
