...
/-! `pos` entries 4000-5999, where an entry is one proven implication with its proof.
...
shard -- is indexed from 0. Add 4000 to get an index into `pos`.
-/

namespace EndToEnd

set_option maxRecDepth 20000 in
def pos2 : RArray PosFact :=
  loadPosTable% "json/pos.json" 16077293896641032754
    entries 4000 to 6000
