...
theorem Equation4457_implies_Equation4452 (G : Type*) [Magma G] (h : Equation4457 G) : Equation4452 G := by
  ...
  have eq11543 (X1 X2 X3 X4 X5 : G) : ((X2 ◇ X1) ◇ (X3 ◇ (X2 ◇ X3))) = (X4 ◇ (X5 ◇ (X4 ◇ X5))) := superpose eq66 eq11438 -- superposition 11438,66, 66 into 11438, unify on (0).2 in 66 and (0).1 in 11438
  have eq11701 (X1 X2 X3 X4 : G) : (X1 ◇ (X2 ◇ (X1 ◇ X2))) ≠ ((X3 ◇ sK1) ◇ (X4 ◇ (X3 ◇ X4))) := superpose eq11438 eq291 -- superposition 291,11438, 11438 into 291, unify on (0).2 in 11438 and (0).2 in 291
  subsumption eq11701 eq11543
...
theorem Equation4457_implies_Equation4462 (G : Type*) [Magma G] (h : Equation4457 G) : Equation4462 G := by
  ...
  have eq297 (X1 X2 : G) : ((X1 ◇ sK1) ◇ sK1) ≠ ((X2 ◇ sK2) ◇ sK2) := superpose eq9 eq197 -- superposition 197,9, 9 into 197, unify on (0).2 in 9 and (0).2 in 197
  have eq444 (X1 X2 X3 : G) : ((X1 ◇ sK2) ◇ ((X2 ◇ X1) ◇ X1)) ≠ ((X3 ◇ sK1) ◇ sK1) := superpose eq11 eq297 -- superposition 297,11, 11 into 297, unify on (0).2 in 11 and (0).2 in 297
  have eq10958 (X0 X1 X2 X3 : G) : ((X3 ◇ X1) ◇ X1) = (X0 ◇ (X2 ◇ (X0 ◇ X2))) := superpose eq114 eq158 -- superposition 158,114, 114 into 158, unify on (0).2 in 114 and (0).2 in 158
  have eq11059 (X1 X2 X3 X4 X5 : G) : ((X2 ◇ X1) ◇ ((X3 ◇ X2) ◇ X2)) = (X4 ◇ (X5 ◇ (X4 ◇ X5))) := superpose eq11 eq10958 -- superposition 10958,11, 11 into 10958, unify on (0).2 in 11 and (0).1 in 10958
  have eq11220 (X1 X2 X3 X4 : G) : (X1 ◇ (X2 ◇ (X1 ◇ X2))) ≠ ((X3 ◇ sK2) ◇ ((X4 ◇ X3) ◇ X3)) := superpose eq10958 eq444 -- superposition 444,10958, 10958 into 444, unify on (0).2 in 10958 and (0).2 in 444
  subsumption eq11220 eq11059
