...
theorem «Facts from FinitePoly [[0,2,1,4,1],[2,1,2,4,4],[3,1,2,4,1],[4,2,0,3,4],[0,2,1,3,4]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [3102] [1238, 2087, 2456, 2530, 2669, 2696, 2862, 2899, 2936, 3065, 3139, 4080] :=
    ⟨Fin 5, «FinitePoly [[0,2,1,4,1],[2,1,2,4,4],[3,1,2,4,1],[4,2,0,3,4],[0,2,1,3,4]]», by decideFin!⟩
