...
theorem «Facts from FinitePoly [[0,0,0,4,4],[2,2,2,2,2],[3,3,3,3,3],[1,1,1,1,1],[4,4,4,0,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2647, 2853] [3319, 3522] :=
    ⟨Fin 5, «FinitePoly [[0,0,0,4,4],[2,2,2,2,2],[3,3,3,3,3],[1,1,1,1,1],[4,4,4,0,0]]», Finite.of_fintype _, by decideFin!⟩
