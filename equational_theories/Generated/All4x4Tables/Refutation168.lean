...
def «FinitePoly [[0,0,1],[1,1,0],[1,2,2]]» : Magma (Fin 3) where
  op := memoFinOp fun x y => [[0,0,1],[1,1,0],[1,2,2]][x.val]![y.val]!

/-! The facts -/
@[equational_result]
theorem «Facts from FinitePoly [[0,0,1],[1,1,0],[1,2,2]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [829, 1236] [377, 378, 822, 1025, 1028, 1225, 1229, 1231, 1631, 2446, 3315, 3316, 3458, 3518, 3519, 3521, 3714, 3721, 3724, 3725, 3924, 3925, 3927, 3928, 4067, 4120, 4121, 4128, 4130, 4314, 4433, 4435, 4436, 4472, 4473, 4598, 4599, 4629] :=
    ⟨Fin 3, «FinitePoly [[0,0,1],[1,1,0],[1,2,2]]», Finite.of_fintype _, by decideFin!⟩
