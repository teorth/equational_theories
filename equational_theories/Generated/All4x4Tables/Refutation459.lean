...
theorem «Facts from FinitePoly [[0,1,2,4,3],[1,0,3,2,4],[2,4,0,3,1],[3,2,4,1,0],[4,3,1,0,2]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [861, 1793] [23, 411, 614, 835, 842, 1020, 1223, 1832, 3253, 3659, 3862, 4270, 4598] :=
    ⟨Fin 5, «FinitePoly [[0,1,2,4,3],[1,0,3,2,4],[2,4,0,3,1],[3,2,4,1,0],[4,3,1,0,2]]», Finite.of_fintype _, by decideFin!⟩
