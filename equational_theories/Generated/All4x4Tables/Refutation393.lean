...
theorem «Facts from FinitePoly [[2,0,0,1],[3,3,3,3],[2,2,2,2],[2,1,2,2]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [4066] [4067, 4068, 4071, 4073, 4270, 4583] :=
    ⟨Fin 4, «FinitePoly [[2,0,0,1],[3,3,3,3],[2,2,2,2],[2,1,2,2]]», Finite.of_fintype _, by decideFin!⟩
