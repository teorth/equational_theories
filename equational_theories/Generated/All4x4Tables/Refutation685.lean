...
theorem «Facts from FinitePoly [[2,0,0,4,0],[1,4,4,1,1],[2,3,4,2,2],[4,3,3,4,3],[4,4,4,4,4]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [433] [819, 1023, 1224, 1226, 1229, 3306, 3873, 4070, 4073, 4584] :=
    ⟨Fin 5, «FinitePoly [[2,0,0,4,0],[1,4,4,1,1],[2,3,4,2,2],[4,3,3,4,3],[4,4,4,4,4]]», by decideFin!⟩
