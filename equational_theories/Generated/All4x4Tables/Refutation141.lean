...
theorem «Facts from FinitePoly [[3,2,3,1],[3,2,1,3],[1,1,3,2],[2,3,2,1]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [3588, 3994] [3253, 3462, 3522, 3659, 3880, 3915, 4065, 4273, 4380, 4647] :=
    ⟨Fin 4, «FinitePoly [[3,2,3,1],[3,2,1,3],[1,1,3,2],[2,3,2,1]]», Finite.of_fintype _, by decideFin!⟩
