...
theorem «Facts from FinitePoly [[4,3,0,1,0],[2,4,0,1,1],[2,3,4,1,2],[2,3,0,4,3],[4,4,4,4,4]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [1043] [105, 833, 1046, 1229, 1239, 1242, 3318, 3724, 3864] :=
    ⟨Fin 5, «FinitePoly [[4,3,0,1,0],[2,4,0,1,1],[2,3,4,1,2],[2,3,0,4,3],[4,4,4,4,4]]», by decideFin!⟩
