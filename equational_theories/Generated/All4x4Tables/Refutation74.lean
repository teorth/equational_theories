...
def «All4x4Tables [[0,0,0],[0,0,0],[1,2,0]]» : Magma (Fin 3) where
  op := finOpTable "[[0,0,0],[0,0,0],[1,2,0]]"

/-! The facts -/
@[equational_result]
theorem «Facts from All4x4Tables [[0,0,0],[0,0,0],[1,2,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [371, 3882, 3899, 4076, 4109, 4318] [3253, 3456, 3664, 3667, 3668, 3674, 3675, 3678, 3721, 3724, 3725, 3865, 3887, 3915, 3925, 3928, 3952, 3955, 3962, 4131, 4158, 4268, 4275, 4283, 4284, 4290, 4293, 4300, 4380, 4635, 4673] :=
    ⟨Fin 3, «All4x4Tables [[0,0,0],[0,0,0],[1,2,0]]», Finite.of_fintype _, by decideFin!⟩
