...
theorem «Facts from FinitePoly [[0,3,1,0],[3,1,1,1],[3,2,2,2],[3,3,3,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [618, 839, 1245, 1259] [361, 427, 430, 439, 820, 823, 1224, 1226, 3318, 3918] :=
    ⟨Fin 4, «FinitePoly [[0,3,1,0],[3,1,1,1],[3,2,2,2],[3,3,3,3]]», Finite.of_fintype _, by decideFin!⟩
