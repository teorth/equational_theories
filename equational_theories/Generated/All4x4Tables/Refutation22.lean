...
theorem «Facts from FinitePoly [[1,2,3,4,5,6,7,0],[6,3,4,5,2,7,0,1],[7,0,5,6,3,4,1,2],[4,5,6,3,0,1,2,7],[5,6,7,0,1,2,3,4],[2,7,0,1,6,3,4,5],[3,4,1,2,7,0,5,6],[0,1,2,7,4,5,6,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [1932] [411, 707, 817, 1426, 2035, 3050, 4380] :=
    ⟨Fin 8, «FinitePoly [[1,2,3,4,5,6,7,0],[6,3,4,5,2,7,0,1],[7,0,5,6,3,4,1,2],[4,5,6,3,0,1,2,7],[5,6,7,0,1,2,3,4],[2,7,0,1,6,3,4,5],[3,4,1,2,7,0,5,6],[0,1,2,7,4,5,6,3]]», Finite.of_fintype _, by decideFin!⟩
