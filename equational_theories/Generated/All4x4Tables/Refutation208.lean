...
theorem «Facts from FinitePoly [[3,1,1,1],[3,1,1,1],[2,3,3,3],[2,3,3,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [3947, 4359] [3253, 3456, 4065, 4599, 4605, 4608, 4631, 4658] :=
    ⟨Fin 4, «FinitePoly [[3,1,1,1],[3,1,1,1],[2,3,3,3],[2,3,3,3]]», Finite.of_fintype _, by decideFin!⟩
