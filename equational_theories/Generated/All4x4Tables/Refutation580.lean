...
theorem «Facts from FinitePoly [[1,2,4,1,4,4],[3,0,3,3,0,3],[5,5,5,0,5,5],[4,1,1,4,1,1],[0,3,0,5,3,0],[2,4,2,2,2,2]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [2260] [203, 1426, 3050, 3456, 4656] :=
    ⟨Fin 6, «FinitePoly [[1,2,4,1,4,4],[3,0,3,3,0,3],[5,5,5,0,5,5],[4,1,1,4,1,1],[0,3,0,5,3,0],[2,4,2,2,2,2]]», by decideFin!⟩
