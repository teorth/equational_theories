...
theorem «Facts from FinitePoly [[1,2,1,0,3,0,0],[1,5,5,1,3,2,1],[0,1,4,4,3,5,3],[1,5,4,6,2,0,3],[2,2,3,2,2,2,3],[2,5,0,5,3,0,5],[1,5,3,3,3,0,3]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [3352] [3456, 3862, 4380] :=
    ⟨Fin 7, «FinitePoly [[1,2,1,0,3,0,0],[1,5,5,1,3,2,1],[0,1,4,4,3,5,3],[1,5,4,6,2,0,3],[2,2,3,2,2,2,3],[2,5,0,5,3,0,5],[1,5,3,3,3,0,3]]», by decideFin!⟩
