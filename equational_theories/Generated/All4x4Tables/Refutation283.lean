...
theorem «Facts from FinitePoly [[0,3,0,3],[3,2,2,3],[0,2,2,3],[3,3,3,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [3346, 3558, 4120, 4165] [3319, 3522, 3915, 4118, 4290, 4320] :=
    ⟨Fin 4, «FinitePoly [[0,3,0,3],[3,2,2,3],[0,2,2,3],[3,3,3,3]]», Finite.of_fintype _, by decideFin!⟩
