...
theorem «Facts from FinitePoly [[1,2,0,3,6,4,5],[4,1,6,2,5,0,3],[3,5,1,6,4,2,0],[0,4,5,1,3,6,2],[5,6,2,0,1,3,4],[2,3,4,5,0,1,6],[6,0,3,4,2,5,1]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2910] [2035, 2644] :=
    ⟨Fin 7, «FinitePoly [[1,2,0,3,6,4,5],[4,1,6,2,5,0,3],[3,5,1,6,4,2,0],[0,4,5,1,3,6,2],[5,6,2,0,1,3,4],[2,3,4,5,0,1,6],[6,0,3,4,2,5,1]]», Finite.of_fintype _, by decideFin!⟩
