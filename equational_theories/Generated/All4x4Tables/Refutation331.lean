...
theorem «Facts from FinitePoly [[3,1,0,1],[2,2,1,2],[2,2,2,2],[2,1,3,1]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [1240, 1243, 1244, 1245, 1255, 1259, 1263] [107, 817, 1022, 3253, 3862] :=
    ⟨Fin 4, «FinitePoly [[3,1,0,1],[2,2,1,2],[2,2,2,2],[2,1,3,1]]», Finite.of_fintype _, by decideFin!⟩
