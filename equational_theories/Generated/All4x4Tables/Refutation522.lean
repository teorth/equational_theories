...
theorem «Facts from FinitePoly [[1,2,3,4,5,0,6],[6,3,0,2,1,5,4],[5,4,2,6,0,3,1],[2,5,1,0,4,6,3],[4,0,5,3,6,1,2],[3,1,6,5,2,4,0],[0,6,4,1,3,2,5]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [1489,1516,1525] [614,817,3862,4065,4073,4131] :=
    ⟨Fin 7, «FinitePoly [[1,2,3,4,5,0,6],[6,3,0,2,1,5,4],[5,4,2,6,0,3,1],[2,5,1,0,4,6,3],[4,0,5,3,6,1,2],[3,1,6,5,2,4,0],[0,6,4,1,3,2,5]]», by decideFin!⟩
