...
theorem «Facts from FinitePoly [[2,2,2,3],[3,2,0,3],[2,0,2,0],[3,3,0,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [3954] [3253, 3915, 3927, 3962, 4320, 4608, 4636, 4658] :=
    ⟨Fin 4, «FinitePoly [[2,2,2,3],[3,2,0,3],[2,0,2,0],[3,3,0,3]]», Finite.of_fintype _, by decideFin!⟩
