...
theorem «Facts from FinitePoly [[3,3,1,3],[3,3,1,3],[3,3,0,3],[0,1,2,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2296, 2303, 2588, 2812] [1629, 2466, 2496, 2652, 3050, 3456, 4065] :=
    ⟨Fin 4, «FinitePoly [[3,3,1,3],[3,3,1,3],[3,3,0,3],[0,1,2,3]]», Finite.of_fintype _, by decideFin!⟩
