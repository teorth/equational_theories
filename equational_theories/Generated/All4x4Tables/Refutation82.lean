...
def «FinitePoly [[0,2,1],[1,0,1],[2,2,0]]» : Magma (Fin 3) where
  op := memoFinOp fun x y => [[0,2,1],[1,0,1],[2,2,0]][x.val]![y.val]!

/-! The facts -/
@[equational_result]
theorem «Facts from FinitePoly [[0,2,1],[1,0,1],[2,2,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [11, 105, 427, 1045, 1647, 1840, 3282, 3891, 3962] [108, 1023, 1025, 1038, 1048, 1224, 1226, 1229, 1231, 1238, 1242, 1251, 1252, 3279, 3685, 3687, 3881, 3888, 3895, 4065, 4269, 4314, 4591, 4598, 4606, 4608, 4631, 4647] :=
    ⟨Fin 3, «FinitePoly [[0,2,1],[1,0,1],[2,2,0]]», Finite.of_fintype _, by decideFin!⟩
