...
theorem «Facts from FinitePoly [[7,3,1,3,4,3,3,3],[5,3,5,4,4,4,4,3],[7,6,1,4,4,3,3,6],[4,4,4,4,4,4,4,4],[4,4,4,4,4,4,4,4],[4,4,3,4,4,4,4,4],[3,4,3,4,4,4,4,4],[5,4,5,4,4,4,4,4]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [4679] [4673, 4677, 4684] :=
    ⟨Fin 8, «FinitePoly [[7,3,1,3,4,3,3,3],[5,3,5,4,4,4,4,3],[7,6,1,4,4,3,3,6],[4,4,4,4,4,4,4,4],[4,4,4,4,4,4,4,4],[4,4,3,4,4,4,4,4],[3,4,3,4,4,4,4,4],[5,4,5,4,4,4,4,4]]», by decideFin!⟩
