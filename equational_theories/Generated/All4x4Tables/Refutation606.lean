...
theorem «Facts from FinitePoly [[0,1,0,3,4,5],[2,5,2,5,5,5],[2,1,2,3,4,5],[0,1,2,4,4,4],[0,5,2,5,5,5],[0,3,2,3,3,3]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [2683] [2035, 2646, 2659, 2669, 2849, 2852, 2865, 2872, 2890, 3309, 3319, 3509, 3519, 3522, 4284, 4631] :=
    ⟨Fin 6, «FinitePoly [[0,1,0,3,4,5],[2,5,2,5,5,5],[2,1,2,3,4,5],[0,1,2,4,4,4],[0,5,2,5,5,5],[0,3,2,3,3,3]]», by decideFin!⟩
