...
theorem «Facts from FinitePoly [[0,2,1,4,3],[1,3,0,2,4],[2,0,4,3,1],[3,4,2,1,0],[4,1,3,0,2]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [1061, 1073] [419, 427, 436, 614, 817, 1023, 1028, 1036, 1045, 1075, 1223, 1426, 1629, 1832, 2035, 2238, 2459, 3253, 3659, 3862, 4270, 4598, 4647] :=
    ⟨Fin 5, «FinitePoly [[0,2,1,4,3],[1,3,0,2,4],[2,0,4,3,1],[3,4,2,1,0],[4,1,3,0,2]]», Finite.of_fintype _, by decideFin!⟩
