...
theorem «Facts from FinitePoly [[0,1,2,1],[3,1,2,3],[0,1,2,3],[0,0,0,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2787] [1025, 1847, 2243, 2253, 2300, 2446, 2466, 2649, 2804, 3346, 3353, 3546, 3759, 3867, 4320, 4445] :=
    ⟨Fin 4, «FinitePoly [[0,1,2,1],[3,1,2,3],[0,1,2,3],[0,0,0,3]]», Finite.of_fintype _, by decideFin!⟩
