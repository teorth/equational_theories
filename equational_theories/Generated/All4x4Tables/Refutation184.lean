...
theorem «Facts from FinitePoly [[0,3,3,3],[1,1,2,2],[1,1,2,2],[0,3,3,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [3515, 3736, 4402] [3255, 3316, 3461, 3464, 4269, 4435] :=
    ⟨Fin 4, «FinitePoly [[0,3,3,3],[1,1,2,2],[1,1,2,2],[0,3,3,3]]», Finite.of_fintype _, by decideFin!⟩
