...
theorem «Facts from FinitePoly [[2,0,1,3],[3,0,0,2],[0,2,3,1],[1,3,2,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [1838, 1897, 1922] [47, 1629, 2441, 3050, 3456, 4118] :=
    ⟨Fin 4, «FinitePoly [[2,0,1,3],[3,0,0,2],[0,2,3,1],[1,3,2,0]]», Finite.of_fintype _, by decideFin!⟩
