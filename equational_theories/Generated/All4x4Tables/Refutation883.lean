...
theorem «Facts from FinitePoly [[5,3,1,2,7,0,6,4],[2,5,4,3,0,1,7,6],[4,7,5,1,6,2,0,3],[6,4,0,5,1,3,2,7],[0,2,7,6,5,4,3,1],[7,6,2,4,3,5,1,0],[1,0,3,7,4,6,5,2],[3,1,6,0,2,7,4,5]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [978] [466, 1848] :=
    ⟨Fin 8, «FinitePoly [[5,3,1,2,7,0,6,4],[2,5,4,3,0,1,7,6],[4,7,5,1,6,2,0,3],[6,4,0,5,1,3,2,7],[0,2,7,6,5,4,3,1],[7,6,2,4,3,5,1,0],[1,0,3,7,4,6,5,2],[3,1,6,0,2,7,4,5]]», Finite.of_fintype _, by decideFin!⟩
