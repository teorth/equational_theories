...
theorem «Facts from FinitePoly [[0,3,3,3],[3,1,2,2],[3,1,2,3],[0,1,2,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2513, 2716] [1045, 1921, 2300, 2327, 2337, 2540, 2743, 3068, 3346, 3353, 3546, 3759, 3887, 4320, 4445] :=
    ⟨Fin 4, «FinitePoly [[0,3,3,3],[3,1,2,2],[3,1,2,3],[0,1,2,3]]», Finite.of_fintype _, by decideFin!⟩
