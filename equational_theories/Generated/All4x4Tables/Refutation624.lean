...
theorem «Facts from FinitePoly [[1,5,5,3,5,5,5],[2,2,2,2,2,2,6],[3,3,3,3,4,5,3],[6,1,6,6,6,6,6],[1,1,1,3,1,5,1],[6,6,6,6,6,6,6],[0,4,2,4,4,4,4]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [2886] [255, 2035, 2644, 2849, 2855, 3253, 3456] :=
    ⟨Fin 7, «FinitePoly [[1,5,5,3,5,5,5],[2,2,2,2,2,2,6],[3,3,3,3,4,5,3],[6,1,6,6,6,6,6],[1,1,1,3,1,5,1],[6,6,6,6,6,6,6],[0,4,2,4,4,4,4]]», by decideFin!⟩
