...
theorem «Facts from FinitePoly [[0,2,5,4,5,0],[4,1,4,4,1,1],[3,5,2,2,5,2],[2,2,3,3,3,3],[4,2,5,5,4,4],[2,2,5,5,5,5]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [827] [616, 1026, 3318, 3918, 4131] :=
    ⟨Fin 6, «FinitePoly [[0,2,5,4,5,0],[4,1,4,4,1,1],[3,5,2,2,5,2],[2,2,3,3,3,3],[4,2,5,5,4,4],[2,2,5,5,5,5]]», by decideFin!⟩
