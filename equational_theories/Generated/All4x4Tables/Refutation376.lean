...
theorem «Facts from FinitePoly [[3,3,2,3],[2,3,2,3],[2,2,2,3],[3,2,2,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [343] [3319, 3456, 3862, 4065, 4380, 4635] :=
    ⟨Fin 4, «FinitePoly [[3,3,2,3],[2,3,2,3],[2,2,2,3],[3,2,2,3]]», Finite.of_fintype _, by decideFin!⟩
