...
theorem «Facts from FinitePoly [[1,3,3,0,2],[2,3,3,4,1],[2,3,3,4,2],[1,3,3,4,1],[2,3,3,4,2]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [828, 838] [1426, 3862, 4065] :=
    ⟨Fin 5, «FinitePoly [[1,3,3,0,2],[2,3,3,4,1],[2,3,3,4,2],[1,3,3,4,1],[2,3,3,4,2]]», Finite.of_fintype _, by decideFin!⟩
