...
theorem «Facts from FinitePoly [[0,2,0,4,5,0],[1,1,0,0,1,0],[3,2,2,2,2,4],[3,3,1,3,3,4],[4,4,0,0,4,1],[2,2,5,5,5,5]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [1032] [616, 825, 3318, 3519, 4131] :=
    ⟨Fin 6, «FinitePoly [[0,2,0,4,5,0],[1,1,0,0,1,0],[3,2,2,2,2,4],[3,3,1,3,3,4],[4,4,0,0,4,1],[2,2,5,5,5,5]]», by decideFin!⟩
