...
theorem «Facts from FinitePoly [[0,0,4,0,0],[2,2,2,2,2],[3,3,3,3,3],[1,1,1,1,1],[4,4,0,4,4]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [2666] [2044, 2054, 2672, 2873, 2875, 3318, 3319, 3518, 3522] :=
    ⟨Fin 5, «FinitePoly [[0,0,4,0,0],[2,2,2,2,2],[3,3,3,3,3],[1,1,1,1,1],[4,4,0,4,4]]», by decideFin!⟩
