...
def «All4x4Tables [[0,1,2],[0,0,2],[0,1,1]]» : Magma (Fin 3) where
  op := finOpTable "[[0,1,2],[0,0,2],[0,1,1]]"

/-! The facts -/
@[equational_result]
theorem «Facts from All4x4Tables [[0,1,2],[0,0,2],[0,1,1]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2306, 2739, 3180] [221, 231, 1637, 1657, 1721, 1731, 2293, 2330, 2340, 2496, 2506, 2533, 2543, 2652, 2662, 2672, 3058, 3115, 3152, 3258, 3268, 3271, 3278, 3481, 3509, 3659, 4090, 4155, 4272, 4320, 4606, 4622] :=
    ⟨Fin 3, «All4x4Tables [[0,1,2],[0,0,2],[0,1,1]]», Finite.of_fintype _, by decideFin!⟩
