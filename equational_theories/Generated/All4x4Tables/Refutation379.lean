...
theorem «Facts from FinitePoly [[3,2,2,3],[3,2,0,3],[3,0,3,3],[0,1,2,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2266, 2330, 2506] [203, 2240, 2246, 2293, 3659] :=
    ⟨Fin 4, «FinitePoly [[3,2,2,3],[3,2,0,3],[3,0,3,3],[0,1,2,3]]», Finite.of_fintype _, by decideFin!⟩
