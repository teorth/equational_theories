...
theorem «Facts from FinitePoly [[3,2,1,1],[3,3,1,1],[0,1,2,3],[0,1,2,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2592, 2808, 2964, 2998, 3214] [411, 1020, 1832, 4362] :=
    ⟨Fin 4, «FinitePoly [[3,2,1,1],[3,3,1,1],[0,1,2,3],[0,1,2,3]]», Finite.of_fintype _, by decideFin!⟩
