...
theorem «Facts from FinitePoly [[0,1,2,3,4],[2,3,0,4,1],[1,0,4,2,3],[4,2,3,1,0],[3,4,1,0,2]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2592] [1629, 2238, 2449, 2466, 2496, 2530, 2644, 2847, 3058, 3075, 3105, 3456, 3659, 4065, 4320, 4622] :=
    ⟨Fin 5, «FinitePoly [[0,1,2,3,4],[2,3,0,4,1],[1,0,4,2,3],[4,2,3,1,0],[3,4,1,0,2]]», Finite.of_fintype _, by decideFin!⟩
