...
theorem «Facts from FinitePoly [[3,1,0,1],[3,1,0,1],[3,1,0,1],[3,3,0,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [3939] [3915, 3925, 4076, 4121, 4134, 4146, 4599] :=
    ⟨Fin 4, «FinitePoly [[3,1,0,1],[3,1,0,1],[3,1,0,1],[3,3,0,3]]», Finite.of_fintype _, by decideFin!⟩
