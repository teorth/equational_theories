...
theorem «Facts from FinitePoly [[0,0,0,1],[2,1,1,0],[1,2,3,3],[3,3,2,2]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [325] [359, 3306, 3308, 3309, 3315, 3318, 3319, 3509, 3511, 3512, 3519, 3521, 3659, 3862, 4283, 4284, 4314, 4599, 4629] :=
    ⟨Fin 4, «FinitePoly [[0,0,0,1],[2,1,1,0],[1,2,3,3],[3,3,2,2]]», Finite.of_fintype _, by decideFin!⟩
