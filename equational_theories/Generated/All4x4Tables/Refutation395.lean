...
theorem «Facts from FinitePoly [[0,1,1,3],[3,0,1,0],[3,3,0,1],[1,0,3,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [3756] [3253, 3456, 3761, 4065, 4273, 4320, 4380, 4605, 4656] :=
    ⟨Fin 4, «FinitePoly [[0,1,1,3],[3,0,1,0],[3,3,0,1],[1,0,3,0]]», Finite.of_fintype _, by decideFin!⟩
