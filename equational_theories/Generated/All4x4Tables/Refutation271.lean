...
def «All4x4Tables [[0,0,0],[0,0,2],[0,1,0]]» : Magma (Fin 3) where
  op := finOpTable "[[0,0,0],[0,0,2],[0,1,0]]"

/-! The facts -/
@[equational_result]
theorem «Facts from All4x4Tables [[0,0,0],[0,0,2],[0,1,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [385, 3479, 3483, 3679, 3696, 3882, 3885, 4331, 4447, 4457, 4484, 4487] [3462, 3474, 3667, 3675, 3864, 3888, 3925, 4071, 4083, 4131, 4155, 4291, 4396, 4398, 4409, 4435, 4443, 4472, 4480, 4598, 4606, 4629, 4631, 4635, 4636, 4647] :=
    ⟨Fin 3, «All4x4Tables [[0,0,0],[0,0,2],[0,1,0]]», Finite.of_fintype _, by decideFin!⟩
