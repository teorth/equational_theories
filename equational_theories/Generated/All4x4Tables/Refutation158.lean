...
theorem «Facts from FinitePoly [[3,1,1,3],[3,3,1,3],[3,0,0,3],[0,1,2,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2812] [2441, 2659, 2709, 3253, 3664, 3674, 3677, 3749, 4065, 4351] :=
    ⟨Fin 4, «FinitePoly [[3,1,1,3],[3,3,1,3],[3,0,0,3],[0,1,2,3]]», Finite.of_fintype _, by decideFin!⟩
