...
theorem «Facts from FinitePoly [[1,2,3,4,5,0],[0,5,4,3,2,1],[5,4,1,0,3,2],[4,1,2,5,0,3],[3,0,5,2,1,4],[2,3,0,1,4,5]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [917, 1729] [411, 614, 1832, 3050] :=
    ⟨Fin 6, «FinitePoly [[1,2,3,4,5,0],[0,5,4,3,2,1],[5,4,1,0,3,2],[4,1,2,5,0,3],[3,0,5,2,1,4],[2,3,0,1,4,5]]», Finite.of_fintype _, by decideFin!⟩
