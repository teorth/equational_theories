...
theorem «Facts from FinitePoly [[3,3,1,1],[3,2,0,0],[1,1,1,1],[1,0,1,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [1442, 1444, 1838, 1858, 1867] [1629, 1840, 1850, 1860, 2035, 3253, 3462, 3862, 4073, 4284] :=
    ⟨Fin 4, «FinitePoly [[3,3,1,1],[3,2,0,0],[1,1,1,1],[1,0,1,0]]», Finite.of_fintype _, by decideFin!⟩
