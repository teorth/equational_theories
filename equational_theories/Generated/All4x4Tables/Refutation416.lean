...
theorem «Facts from FinitePoly [[2,2,0,1],[3,0,1,0],[2,2,2,2],[1,2,3,2]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [1052, 1253] [835, 1225, 1228, 1238, 1248, 1249] :=
    ⟨Fin 4, «FinitePoly [[2,2,0,1],[3,0,1,0],[2,2,2,2],[1,2,3,2]]», Finite.of_fintype _, by decideFin!⟩
