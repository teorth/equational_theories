...
theorem «Facts from FinitePoly [[2,2,0,1],[3,3,0,1],[3,2,1,1],[3,2,0,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [1958, 2093] [1025, 1035, 1045, 1629, 1894, 2097, 3306, 3346, 3353, 3867, 3877, 3887, 4320] :=
    ⟨Fin 4, «FinitePoly [[2,2,0,1],[3,3,0,1],[3,2,1,1],[3,2,0,0]]», Finite.of_fintype _, by decideFin!⟩
