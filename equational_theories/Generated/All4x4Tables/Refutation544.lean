...
theorem «Facts from FinitePoly [[2,2,2,4,4,4],[3,1,1,3,3,1],[0,5,0,0,5,5],[3,1,1,3,3,1],[0,5,0,0,5,5],[2,2,2,4,4,4]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [1469] [1428, 1431, 1444, 1451, 4269, 4284] :=
    ⟨Fin 6, «FinitePoly [[2,2,2,4,4,4],[3,1,1,3,3,1],[0,5,0,0,5,5],[3,1,1,3,3,1],[0,5,0,0,5,5],[2,2,2,4,4,4]]», by decideFin!⟩
