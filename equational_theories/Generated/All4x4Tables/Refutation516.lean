...
theorem «Facts from FinitePoly [[1,2,4,0,6,5,3],[4,3,1,5,2,0,6],[0,6,5,1,3,4,2],[5,0,6,2,4,3,1],[3,4,2,6,0,1,5],[2,1,3,4,5,6,0],[6,5,0,3,1,2,4]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [219,873,880] [614,620,826,1426,1479,3050,3079,3112,4608] :=
    ⟨Fin 7, «FinitePoly [[1,2,4,0,6,5,3],[4,3,1,5,2,0,6],[0,6,5,1,3,4,2],[5,0,6,2,4,3,1],[3,4,2,6,0,1,5],[2,1,3,4,5,6,0],[6,5,0,3,1,2,4]]», by decideFin!⟩
