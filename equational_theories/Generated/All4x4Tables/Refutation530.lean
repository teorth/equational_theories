...
theorem «Facts from FinitePoly [[0,2,0,4,0],[1,1,1,1,1],[3,4,2,2,2],[4,3,4,3,3],[4,4,4,4,4]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [1233] [822, 1025, 1028, 1225, 1229, 1631, 2446, 3458, 3721, 3927, 4120, 4127, 4131, 4472, 4598] :=
    ⟨Fin 5, «FinitePoly [[0,2,0,4,0],[1,1,1,1,1],[3,4,2,2,2],[4,3,4,3,3],[4,4,4,4,4]]», by decideFin!⟩
