...
theorem «Facts from FinitePoly [[2,1,3,3],[2,3,3,2],[0,1,2,3],[0,1,2,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2420, 3115] [1657, 1721, 3065, 3253, 3458, 3461, 3519, 3664, 3674, 3677, 3749, 4070, 4131, 4269, 4272] :=
    ⟨Fin 4, «FinitePoly [[2,1,3,3],[2,3,3,2],[0,1,2,3],[0,1,2,3]]», Finite.of_fintype _, by decideFin!⟩
