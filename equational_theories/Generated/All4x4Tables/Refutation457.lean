...
theorem «Facts from FinitePoly [[3,0,3,3],[3,3,0,3],[3,0,3,3],[3,0,0,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [314] [3862, 4065, 4380, 4583, 4591, 4608] :=
    ⟨Fin 4, «FinitePoly [[3,0,3,3],[3,3,0,3],[3,0,3,3],[3,0,0,3]]», Finite.of_fintype _, by decideFin!⟩
