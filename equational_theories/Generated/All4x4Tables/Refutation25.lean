...
theorem «Facts from FinitePoly [[0,3,1,3],[3,3,0,3],[1,3,1,3],[0,3,1,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [3893, 4093] [3870, 3877, 4067, 4070, 4080, 4090, 4269, 4599, 4606, 4622, 4635, 4666] :=
    ⟨Fin 4, «FinitePoly [[0,3,1,3],[3,3,0,3],[1,3,1,3],[0,3,1,3]]», Finite.of_fintype _, by decideFin!⟩
