...
theorem «Facts from FinitePoly [[1,2,5,6,4,3,7,0],[4,3,0,7,1,2,6,5],[2,1,7,0,3,4,5,6],[0,6,4,2,5,7,3,1],[7,5,2,4,6,0,1,3],[6,0,3,1,7,5,4,2],[3,4,6,5,2,1,0,7],[5,7,1,3,0,6,2,4]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [1587] [411, 614, 817, 1020, 1229, 1241, 1248, 1252, 1276, 1278, 1429, 1434, 1488, 1515, 1519, 1629, 1832, 2035, 2238, 2441, 2647, 2650, 2652, 2660, 2662, 2699, 2710, 2746, 2847, 3050, 3253, 3456, 3659, 3862, 4065, 4270, 4273, 4275, 4283, 4290, 4320, 4380, 4585, 4588, 4590, 4598, 4605, 4635] :=
    ⟨Fin 8, «FinitePoly [[1,2,5,6,4,3,7,0],[4,3,0,7,1,2,6,5],[2,1,7,0,3,4,5,6],[0,6,4,2,5,7,3,1],[7,5,2,4,6,0,1,3],[6,0,3,1,7,5,4,2],[3,4,6,5,2,1,0,7],[5,7,1,3,0,6,2,4]]», Finite.of_fintype _, by decideFin!⟩
