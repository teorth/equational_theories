...
theorem «Facts from FinitePoly [[1,2,1,1],[3,3,3,2],[0,1,2,3],[2,0,0,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2044] [255, 307, 2053, 2060, 2644, 2847, 3259, 3308, 3319, 3459, 3462, 3511, 3518, 3522, 4283, 4656] :=
    ⟨Fin 4, «FinitePoly [[1,2,1,1],[3,3,3,2],[0,1,2,3],[2,0,0,0]]», Finite.of_fintype _, by decideFin!⟩
