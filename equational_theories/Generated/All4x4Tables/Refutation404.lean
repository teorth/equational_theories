...
theorem «Facts from FinitePoly [[3,3,1,3],[3,3,3,3],[3,3,0,3],[3,3,0,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [3909, 4352] [43, 3253, 3456, 3659, 4065, 4584, 4622] :=
    ⟨Fin 4, «FinitePoly [[3,3,1,3],[3,3,3,3],[3,3,0,3],[3,3,0,3]]», Finite.of_fintype _, by decideFin!⟩
