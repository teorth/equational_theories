...
theorem «Facts from FinitePoly [[2,0,1,0],[1,3,1,1],[2,2,3,2],[3,3,3,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [843, 1039] [99, 411, 1036, 1832, 3253, 3659, 3862] :=
    ⟨Fin 4, «FinitePoly [[2,0,1,0],[1,3,1,1],[2,2,3,2],[3,3,3,3]]», Finite.of_fintype _, by decideFin!⟩
