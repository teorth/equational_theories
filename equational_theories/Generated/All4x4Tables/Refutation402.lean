...
theorem «Facts from FinitePoly [[1,1,2,1],[3,3,3,3],[3,3,1,3],[0,0,0,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2852, 2878] [255, 2035, 2644, 2855, 2865, 3253, 3456, 4269, 4284, 4599, 4631] :=
    ⟨Fin 4, «FinitePoly [[1,1,2,1],[3,3,3,3],[3,3,1,3],[0,0,0,0]]», Finite.of_fintype _, by decideFin!⟩
