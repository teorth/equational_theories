...
def «All4x4Tables [[0,0,0],[0,0,0],[1,0,1]]» : Magma (Fin 3) where
  op := finOpTable "[[0,0,0],[0,0,0],[1,0,1]]"

/-! The facts -/
@[equational_result]
theorem «Facts from All4x4Tables [[0,0,0],[0,0,0],[1,0,1]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [3470, 4387] [307, 3255, 3256, 3660, 3661, 3662, 3665, 3667, 3668, 3862, 4065, 4268, 4269, 4270, 4272, 4273, 4283, 4284, 4293, 4320, 4343, 4396, 4398, 4433, 4435, 4436, 4442, 4443, 4445, 4470, 4472, 4473, 4479, 4480, 4482] :=
    ⟨Fin 3, «All4x4Tables [[0,0,0],[0,0,0],[1,0,1]]», Finite.of_fintype _, by decideFin!⟩
