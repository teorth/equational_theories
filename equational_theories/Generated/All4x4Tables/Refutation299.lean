...
theorem «Facts from FinitePoly [[2,2,3,3],[3,3,2,2],[0,0,1,1],[1,1,0,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2463] [151, 203, 1426, 2035, 2238, 2644, 3253] :=
    ⟨Fin 4, «FinitePoly [[2,2,3,3],[3,3,2,2],[0,0,1,1],[1,1,0,0]]», Finite.of_fintype _, by decideFin!⟩
