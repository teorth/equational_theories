...
theorem «Facts from FinitePoly [[3,0,1,3],[3,3,0,3],[2,2,3,3],[3,3,3,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [3283, 3473] [3255, 3279, 3461, 3462, 3474, 3475] :=
    ⟨Fin 4, «FinitePoly [[3,0,1,3],[3,3,0,3],[2,2,3,3],[3,3,3,3]]», Finite.of_fintype _, by decideFin!⟩
