...
theorem «Facts from FinitePoly [[3,2,3,3],[3,3,3,3],[0,3,1,3],[3,3,3,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [4457] [4435, 4443, 4629, 4631, 4635, 4636, 4647] :=
    ⟨Fin 4, «FinitePoly [[3,2,3,3],[3,3,3,3],[0,3,1,3],[3,3,3,3]]», Finite.of_fintype _, by decideFin!⟩
