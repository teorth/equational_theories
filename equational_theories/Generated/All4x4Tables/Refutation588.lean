...
theorem «Facts from FinitePoly [[0,2,3,2,2],[2,1,4,2,4],[0,1,2,3,4],[4,1,2,3,4],[0,3,2,3,4]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [2398, 2513, 2550] [333, 1025, 1647, 1847, 2243, 2253, 2466, 2649, 3867] :=
    ⟨Fin 5, «FinitePoly [[0,2,3,2,2],[2,1,4,2,4],[0,1,2,3,4],[4,1,2,3,4],[0,3,2,3,4]]», by decideFin!⟩
