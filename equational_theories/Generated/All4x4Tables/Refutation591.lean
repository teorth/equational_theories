...
theorem «Facts from FinitePoly [[0,2,5,4,3,2],[1,1,1,1,1,1],[4,3,2,5,0,3],[2,4,0,3,5,4],[5,0,3,2,4,0],[3,5,4,0,2,5]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2450] [209, 1444] :=
    ⟨Fin 6, «FinitePoly [[0,2,5,4,3,2],[1,1,1,1,1,1],[4,3,2,5,0,3],[2,4,0,3,5,4],[5,0,3,2,4,0],[3,5,4,0,2,5]]», Finite.of_fintype _, by decideFin!⟩
