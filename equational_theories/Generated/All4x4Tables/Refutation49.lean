...
theorem «Facts from FinitePoly [[0,2,2,3],[3,1,2,3],[0,1,0,3],[0,1,2,1]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2306] [2646, 2662, 2706, 2709, 3058, 3078, 3105, 3142, 3255, 3261, 3467, 3509, 3664, 3684, 3712, 4131, 4165, 4269] :=
    ⟨Fin 4, «FinitePoly [[0,2,2,3],[3,1,2,3],[0,1,0,3],[0,1,2,1]]», Finite.of_fintype _, by decideFin!⟩
