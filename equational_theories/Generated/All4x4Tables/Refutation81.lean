...
theorem «Facts from FinitePoly [[0,0,3,3],[2,3,2,2],[1,1,2,3],[0,0,2,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2259, 2277, 2462, 2469] [151, 1629, 2281, 2449, 2466, 2644, 3050, 3253, 3456, 3659, 4065, 4269, 4270, 4314, 4320, 4631] :=
    ⟨Fin 4, «FinitePoly [[0,0,3,3],[2,3,2,2],[1,1,2,3],[0,0,2,0]]», Finite.of_fintype _, by decideFin!⟩
