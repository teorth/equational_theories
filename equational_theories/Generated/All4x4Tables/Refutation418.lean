...
theorem «Facts from FinitePoly [[1,0,1,3],[2,3,0,1],[1,2,1,3],[3,1,3,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [430, 617, 620, 630, 1226, 1249] [99, 359, 817, 1238, 1248, 1251, 3659] :=
    ⟨Fin 4, «FinitePoly [[1,0,1,3],[2,3,0,1],[1,2,1,3],[3,1,3,0]]», Finite.of_fintype _, by decideFin!⟩
