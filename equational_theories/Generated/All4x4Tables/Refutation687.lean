...
theorem «Facts from FinitePoly [[2,3,0,1,5,0],[2,5,4,1,2,1],[2,3,5,1,2,2],[2,3,4,5,2,3],[5,3,4,1,5,4],[5,5,5,5,5,5]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [433] [818, 833, 836, 1249, 3315, 3864, 3870, 4631] :=
    ⟨Fin 6, «FinitePoly [[2,3,0,1,5,0],[2,5,4,1,2,1],[2,3,5,1,2,2],[2,3,4,5,2,3],[5,3,4,1,5,4],[5,5,5,5,5,5]]», by decideFin!⟩
