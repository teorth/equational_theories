...
theorem «Facts from FinitePoly [[1,5,4,2,0,3],[2,5,4,1,3,0],[2,5,4,1,3,0],[1,5,4,2,0,3],[1,4,5,2,3,0],[1,4,5,2,3,0]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [690, 1586] [47, 632, 642, 817, 1434, 3915, 3925, 3952, 3962, 4065, 4275, 4320] :=
    ⟨Fin 6, «FinitePoly [[1,5,4,2,0,3],[2,5,4,1,3,0],[2,5,4,1,3,0],[1,5,4,2,0,3],[1,4,5,2,3,0],[1,4,5,2,3,0]]», by decideFin!⟩
