...
theorem «Facts from FinitePoly [[0,1,2,3],[1,0,0,0],[2,2,0,0],[3,2,0,0]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [647, 1523, 2132] [1023, 1026, 1038, 1045, 1229, 1231, 1239, 1241, 3549, 3955, 4598] :=
    ⟨Fin 4, «FinitePoly [[0,1,2,3],[1,0,0,0],[2,2,0,0],[3,2,0,0]]», Finite.of_fintype _, by decideFin!⟩
