...
theorem «Facts from FinitePoly [[3,1,1,3],[3,3,3,3],[0,1,0,3],[0,1,2,3]]» :
  ∃ (G : Type) (_ : Magma G) (_: Finite G), Facts G [2709] [2441, 2736, 3261, 3278, 3659, 4131] :=
    ⟨Fin 4, «FinitePoly [[3,1,1,3],[3,3,3,3],[0,1,0,3],[0,1,2,3]]», Finite.of_fintype _, by decideFin!⟩
