...
theorem «Facts from FinitePoly [[0,2,5,5,0,5],[4,1,2,1,4,1],[4,3,2,3,4,2],[4,3,2,3,4,3],[4,3,2,3,4,4],[0,5,5,5,5,5]]» :
  ∃ (G : Type) (_ : Magma G), Facts G [645] [629, 835, 842, 3867, 3928, 4131] :=
    ⟨Fin 6, «FinitePoly [[0,2,5,5,0,5],[4,1,2,1,4,1],[4,3,2,3,4,2],[4,3,2,3,4,3],[4,3,2,3,4,4],[0,5,5,5,5,5]]», by decideFin!⟩
