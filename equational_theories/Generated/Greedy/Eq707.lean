...
theorem rule_0_preserved (G : Type*) (a b c : G) (old : G → G → G → Prop) (new : G → G → G → Prop) (sP0 : G → G → G → Prop) (sF0 : G → G → G → G) (sP1 : G → G → G → Prop) (bc : c ≠ b) (p3 : ∀ X0, ¬ old a b X0) (p4XY : ∀ X1 X2, ¬ old X1 X2 c) (p4XZ : ∀ X1 X2, ¬ old X1 c X2) (p4YZ : ∀ X1 X2, ¬ old c X1 X2) (old_0 : (∀ X0 X1 X2 X3, ¬ old X0 X1 X2 ∨ ¬ old X0 X1 X3 ∨ X2 = X3)) (old_2 : (∀ X0 X1 X2 X3, ¬ old X0 X1 X2 ∨ ¬ old X3 X1 X2 ∨ X0 = X3)) (rule_def_0_0 : ∀ (X Y Z : G), a = X ∨ ¬sP0 X Y Z) (rule_def_0_1 : ∀ (X Y Z : G), b = Y ∨ ¬sP0 X Y Z) (rule_def_0_2 : ∀ (X Y Z : G), c = Z ∨ ¬sP0 X Y Z) (imp_new_2 : ∀ X Y Z X2, a ≠ X ∨ c ≠ Y ∨ ¬ old Z a X2 ∨ ¬ old X2 a b ∨ new X Y Z) (rule_def_1_0 : ∀ (X Y Z : G), a = X ∨ ¬sP1 X Y Z) (rule_def_1_1 : ∀ (X Y Z : G), c = Y ∨ ¬sP1 X Y Z) (rule_def_1_2 : ∀ (X Y Z : G), old Z a (sF0 X Y Z) ∨ ¬sP1 X Y Z) (rule_def_1_3 : ∀ (X Y Z : G), old (sF0 X Y Z) a b ∨ ¬sP1 X Y Z) (new_imp : ∀ (X Y Z), ¬ new X Y Z ∨ old X Y Z ∨ sP0 X Y Z ∨ sP1 X Y Z) : (∀ X0 X1 X2 X3, ¬ new X0 X1 X2 ∨ ¬ new X0 X1 X3 ∨ X2 = X3) := by
  ...
  have eq127 : (sP0 a sk1 sk2) ∨ (sP1 sk0 sk1 sk2) ∨ (old sk0 sk1 sk2) := Eq.mp (by grind only) eq91 -- backward demodulation 91,124
  have eq128 : (sP0 a sk1 sk3) ∨ (sP1 sk0 sk1 sk3) ∨ (old sk0 sk1 sk3) := Eq.mp (by grind only) eq92 -- backward demodulation 92,124
  have eq129 : (sP0 a sk1 sk2) ∨ (old sk0 sk1 sk2) ∨ c = sk1 := Eq.mp (by grind only) eq98 -- backward demodulation 98,124
  have eq131 : (sP0 a sk1 sk3) ∨ (old sk0 sk1 sk3) ∨ c = sk1 := Eq.mp (by grind only) eq106 -- backward demodulation 106,124
  have eq135 : ∀ (X0 : G) , (sP0 a sk1 sk2) ∨ (sF0 sk0 sk1 sk2) = X0 ∨ ¬(old X0 a b) ∨ (old sk0 sk1 sk2) := Eq.mp (by grind only) eq118 -- backward demodulation 118,124
  have eq137 : (sP1 a sk1 sk2) ∨ (sP0 a sk1 sk2) ∨ (old sk0 sk1 sk2) := Eq.mp (by grind only) eq127 -- forward demodulation 127,124
  have eq138 : (sP1 a sk1 sk2) ∨ (old a sk1 sk2) ∨ (sP0 a sk1 sk2) := Eq.mp (by grind only) eq137 -- forward demodulation 137,124
  have eq139 : (sP1 a sk1 sk3) ∨ (sP0 a sk1 sk3) ∨ (old sk0 sk1 sk3) := Eq.mp (by grind only) eq128 -- forward demodulation 128,124
  have eq140 : (sP1 a sk1 sk3) ∨ (old a sk1 sk3) ∨ (sP0 a sk1 sk3) := Eq.mp (by grind only) eq139 -- forward demodulation 139,124
  have eq141 : (sP0 a sk1 sk2) ∨ (old a sk1 sk2) ∨ c = sk1 := Eq.mp (by grind only) eq129 -- forward demodulation 129,124
  have eq142 : (sP0 a sk1 sk3) ∨ (old a sk1 sk3) ∨ c = sk1 := Eq.mp (by grind only) eq131 -- forward demodulation 131,124
  have eq147 : ∀ (X0 : G) , (sF0 a sk1 sk2) = X0 ∨ (sP0 a sk1 sk2) ∨ ¬(old X0 a b) ∨ (old sk0 sk1 sk2) := Eq.mp (by grind only) eq135 -- forward demodulation 135,124
  have eq148 : ∀ (X0 : G) , ¬(old X0 a b) ∨ (sF0 a sk1 sk2) = X0 ∨ (sP0 a sk1 sk2) ∨ (old a sk1 sk2) := Eq.mp (by grind only) eq147 -- forward demodulation 147,124
  ...
  have eq334 : (sP0 a c sk2) ∨ (sP1 a sk1 sk2) ∨ (old a sk1 sk2) := Eq.mp (by grind only) eq138 -- backward demodulation 138,331
  have eq335 : (sP0 a c sk3) ∨ (sP1 a sk1 sk3) ∨ (old a sk1 sk3) := Eq.mp (by grind only) eq140 -- backward demodulation 140,331
  have eq357 : (old a c sk3) ∨ (sP1 a c sk3) ∨ c = sk3 := Eq.mp (by grind only) eq230 -- backward demodulation 230,331
  have eq365 : (sP0 a c sk2) ∨ (old a sk1 sk2) ∨ (sF0 a sk1 sk2) = (sF0 a c sk3) ∨ c = sk3 ∨ (old a sk1 sk3) := Eq.mp (by grind only) eq317 -- backward demodulation 317,331
  have eq366 : (sP1 a c sk2) ∨ (sP0 a c sk2) ∨ (old a sk1 sk2) := Eq.mp (by grind only) eq334 -- forward demodulation 334,331
  have eq367 : (old a c sk2) ∨ (sP1 a c sk2) ∨ (sP0 a c sk2) := Eq.mp (by grind only) eq366 -- forward demodulation 366,331
  have eq368 : (sP1 a c sk2) ∨ (sP0 a c sk2) := resolve eq367 p4XZ -- subsumption resolution 367,48
  have eq369 : (sP1 a c sk3) ∨ (sP0 a c sk3) ∨ (old a sk1 sk3) := Eq.mp (by grind only) eq335 -- forward demodulation 335,331
  have eq370 : (old a c sk3) ∨ (sP1 a c sk3) ∨ (sP0 a c sk3) := Eq.mp (by grind only) eq369 -- forward demodulation 369,331
  ...
  have eq416 : (old a c sk2) ∨ (sP0 a c sk2) ∨ (sF0 a sk1 sk2) = (sF0 a c sk3) ∨ c = sk3 ∨ (old a sk1 sk3) := Eq.mp (by grind only) eq365 -- forward demodulation 365,331
  have eq417 : (sP0 a c sk2) ∨ (sF0 a sk1 sk2) = (sF0 a c sk3) ∨ c = sk3 ∨ (old a sk1 sk3) := resolve eq416 p4XZ -- subsumption resolution 416,48
  have eq418 : (sF0 a c sk2) = (sF0 a c sk3) ∨ (sP0 a c sk2) ∨ c = sk3 ∨ (old a sk1 sk3) := Eq.mp (by grind only) eq417 -- forward demodulation 417,331
  have eq419 : (old a c sk3) ∨ (sF0 a c sk2) = (sF0 a c sk3) ∨ (sP0 a c sk2) ∨ c = sk3 := Eq.mp (by grind only) eq418 -- forward demodulation 418,331
  ...
  have eq569 : (sP0 a c c) ∨ (sP1 a c sk3) := Eq.mp (by grind only) eq371 -- backward demodulation 371,566
  have eq594 : (sP1 a c c) ∨ (sP0 a c c) := Eq.mp (by grind only) eq569 -- forward demodulation 569,566
...
theorem rule_1_preserved (G : Type*) (a b c : G) (old : G → G → G → Prop) (new : G → G → G → Prop) (sP0 : G → G → G → Prop) (sF0 : G → G → G → G) (sP1 : G → G → G → Prop) (ac : a ≠ c) (bc : c ≠ b) (p4XY : ∀ X1 X2, ¬ old X1 X2 c) (p4XZ : ∀ X1 X2, ¬ old X1 c X2) (p4YZ : ∀ X1 X2, ¬ old c X1 X2) (prev_0 : (∀ X0 X1 X2 X3, ¬ new X0 X1 X2 ∨ ¬ new X0 X1 X3 ∨ X2 = X3)) (old_1 : (∀ X0 X1 X2 X3 X4, ¬ old X0 X1 X2 ∨ ¬ old X1 X3 X4 ∨ ¬ old X2 X1 X3 ∨ old X1 X4 X0)) (old_2 : (∀ X0 X1 X2 X3, ¬ old X0 X1 X2 ∨ ¬ old X3 X1 X2 ∨ X0 = X3)) (old_3 : (∀ X0 X1 X2, ¬ old X0 X1 X1 ∨ ¬ old X2 X1 X0 ∨ old X1 X2 X0)) (imp_new_1 : ∀ X Y Z, a ≠ X ∨ b ≠ Y ∨ c ≠ Z ∨ new X Y Z) (rule_def_0_0 : ∀ (X Y Z : G), a = X ∨ ¬sP0 X Y Z) (rule_def_0_1 : ∀ (X Y Z : G), b = Y ∨ ¬sP0 X Y Z) (rule_def_0_2 : ∀ (X Y Z : G), c = Z ∨ ¬sP0 X Y Z) (imp_new_2 : ∀ X Y Z X2, a ≠ X ∨ c ≠ Y ∨ ¬ old Z a X2 ∨ ¬ old X2 a b ∨ new X Y Z) (rule_def_1_0 : ∀ (X Y Z : G), a = X ∨ ¬sP1 X Y Z) (rule_def_1_1 : ∀ (X Y Z : G), c = Y ∨ ¬sP1 X Y Z) (rule_def_1_2 : ∀ (X Y Z : G), old Z a (sF0 X Y Z) ∨ ¬sP1 X Y Z) (rule_def_1_3 : ∀ (X Y Z : G), old (sF0 X Y Z) a b ∨ ¬sP1 X Y Z) (new_imp : ∀ (X Y Z), ¬ new X Y Z ∨ old X Y Z ∨ sP0 X Y Z ∨ sP1 X Y Z) (imp_new_0 : ∀ (X Y Z), ¬ old X Y Z ∨ new X Y Z) : (∀ X0 X1 X2 X3 X4, ¬ new X0 X1 X2 ∨ ¬ new X1 X3 X4 ∨ ¬ new X2 X1 X3 ∨ new X1 X4 X0) := by
  ...
  have eq1291 : ¬(new a sk4 sk0) := Eq.mp (by grind only) preserve_3 -- backward demodulation 73,1287
  have eq1307 : (old sk2 a sk3) ∨ a = sk2 := Eq.mp (by grind only) eq125 -- backward demodulation 125,1287
  have eq1321 : (old sk0 a sk2) ∨ c = sk1 ∨ c = sk2 := Eq.mp (by grind only) eq172 -- backward demodulation 172,1287
  have eq1325 : ∀ (X0 : G) , a = c ∨ ¬(old X0 sk1 sk2) ∨ c = sk2 ∨ sk0 = X0 := Eq.mp (by grind only) eq179 -- backward demodulation 179,1287
  have eq1328 : (old a sk3 sk4) ∨ c = sk3 ∨ b = sk3 := Eq.mp (by grind only) eq183 -- backward demodulation 183,1287
  have eq1333 : (old sk2 a sk3) ∨ c = sk1 ∨ c = sk3 := Eq.mp (by grind only) eq192 -- backward demodulation 192,1287
  have eq1334 : (old sk2 a sk3) ∨ c = sk1 ∨ b = sk1 := Eq.mp (by grind only) eq193 -- backward demodulation 193,1287
  have eq1376 : (sP1 a c sk4) ∨ (old a sk3 sk4) ∨ c = sk4 := Eq.mp (by grind only) eq267 -- backward demodulation 267,1287
  have eq1378 : (sP1 a c sk4) ∨ (old a sk3 sk4) ∨ b = sk3 ∨ (sP0 a c sk4) := Eq.mp (by grind only) eq270 -- backward demodulation 270,1287
  have eq1514 : a = c ∨ (old sk1 sk4 sk0) ∨ c = sk3 ∨ c = sk4 ∨ c = sk2 := Eq.mp (by grind only) eq838 -- backward demodulation 838,1287
  have eq1664 : a = c ∨ (old sk0 a sk2) ∨ c = sk2 := Eq.mp (by grind only) eq1321 -- forward demodulation 1321,1287
  ...
  have eq1677 : ∀ (X0 : G) , ¬(old X0 a sk2) ∨ c = sk2 ∨ sk0 = X0 := Eq.mp (by grind only) eq1676 -- forward demodulation 1676,1287
  have eq1695 : a = c ∨ (old sk2 a sk3) ∨ c = sk3 := Eq.mp (by grind only) eq1333 -- forward demodulation 1333,1287
  have eq1696 : (old sk2 a sk3) ∨ c = sk3 := resolve eq1695 ac -- subsumption resolution 1695,47
  have eq1697 : a = c ∨ (old sk2 a sk3) ∨ b = sk1 := Eq.mp (by grind only) eq1334 -- forward demodulation 1334,1287
  have eq1698 : (old sk2 a sk3) ∨ b = sk1 := resolve eq1697 ac -- subsumption resolution 1697,47
  have eq1699 : (old sk2 a sk3) ∨ a = b := Eq.mp (by grind only) eq1698 -- forward demodulation 1698,1287
  have eq1831 : (old sk1 sk4 sk0) ∨ c = sk3 ∨ c = sk4 ∨ c = sk2 := resolve eq1514 ac -- subsumption resolution 1514,47
  have eq1832 : (old a sk4 sk0) ∨ c = sk3 ∨ c = sk4 ∨ c = sk2 := Eq.mp (by grind only) eq1831 -- forward demodulation 1831,1287
  ...
  have eq4957 : ∀ (X0 : G) , a = c ∨ ¬(old X0 a sk2) ∨ sk0 = X0 := Eq.mp (by grind only) eq1677 -- backward demodulation 1677,4937
  have eq4964 : (old a a sk3) ∨ a = b := Eq.mp (by grind only) eq1699 -- backward demodulation 1699,4937
  have eq5045 : a = c ∨ c = sk3 := Eq.mp (by grind only) eq4841 -- backward demodulation 4841,4937
  have eq5066 (X0 : G) : ¬(old X0 a sk2) ∨ sk0 = X0 := resolve eq4957 ac -- subsumption resolution 4957,47
  have eq5067 : ∀ (X0 : G) , ¬(old X0 a a) ∨ sk0 = X0 := Eq.mp (by grind only) eq5066 -- forward demodulation 5066,4937
  have eq5118 : c = sk3 := resolve eq5045 ac -- subsumption resolution 5045,47
  have eq5124 : (old a c sk4) ∨ (sP1 a c sk4) ∨ c = sk4 := Eq.mp (by grind only) eq1376 -- backward demodulation 1376,5118
  have eq5126 : c = b ∨ (sP1 a c sk4) ∨ (old a sk3 sk4) ∨ (sP0 a c sk4) := Eq.mp (by grind only) eq1378 -- backward demodulation 1378,5118
  have eq5190 : (old a a c) ∨ a = b := Eq.mp (by grind only) eq4964 -- backward demodulation 4964,5118
  ...
  have eq5201 : (old a c sk4) ∨ (sP1 a c sk4) ∨ (sP0 a c sk4) := Eq.mp (by grind only) eq5200 -- forward demodulation 5200,5118
  ...
  have eq5262 : ∀ (X0 X1 X2 : G) , ¬(sP0 X0 X1 X2) ∨ a = X1 := Eq.mp (by grind only) rule_def_0_1 -- backward demodulation 60,5259
  have eq5263 : ∀ (X0 X1 X2 : G) , (old (sF0 X0 X1 X2) a a) ∨ ¬(sP1 X0 X1 X2) := Eq.mp (by grind only) rule_def_1_3 -- backward demodulation 66,5259
  ...
  have eq5428 : (sP0 a c c) ∨ (sP1 a c sk4) := Eq.mp (by grind only) eq5202 -- backward demodulation 5202,5419
  have eq5441 : (sP1 a c c) ∨ (sP0 a c c) := Eq.mp (by grind only) eq5428 -- forward demodulation 5428,5419
...
theorem rule_2_preserved (G : Type*) (a b c : G) (old : G → G → G → Prop) (new : G → G → G → Prop) (sP0 : G → G → G → Prop) (sF0 : G → G → G → G) (sP1 : G → G → G → Prop) (p4XY : ∀ X1 X2, ¬ old X1 X2 c) (p4XZ : ∀ X1 X2, ¬ old X1 c X2) (old_2 : (∀ X0 X1 X2 X3, ¬ old X0 X1 X2 ∨ ¬ old X3 X1 X2 ∨ X0 = X3)) (rule_def_0_0 : ∀ (X Y Z : G), a = X ∨ ¬sP0 X Y Z) (rule_def_0_2 : ∀ (X Y Z : G), c = Z ∨ ¬sP0 X Y Z) (rule_def_1_0 : ∀ (X Y Z : G), a = X ∨ ¬sP1 X Y Z) (rule_def_1_1 : ∀ (X Y Z : G), c = Y ∨ ¬sP1 X Y Z) (new_imp : ∀ (X Y Z), ¬ new X Y Z ∨ old X Y Z ∨ sP0 X Y Z ∨ sP1 X Y Z) : (∀ X0 X1 X2 X3, ¬ new X0 X1 X2 ∨ ¬ new X3 X1 X2 ∨ X0 = X3) := by
  ...
  have eq293 : a ≠ sk3 := Eq.mp (by grind only) preserve_2 -- backward demodulation 74,291
  ...
  have eq357 : (old sk3 c sk2) ∨ a = sk3 := Eq.mp (by grind only) eq125 -- backward demodulation 125,349
...
theorem rule_3_preserved (G : Type*) (a b c : G) (old : G → G → G → Prop) (new : G → G → G → Prop) (sP0 : G → G → G → Prop) (sF0 : G → G → G → G) (sP1 : G → G → G → Prop) (ac : a ≠ c) (bc : c ≠ b) (p4XZ : ∀ X1 X2, ¬ old X1 c X2) (p4YZ : ∀ X1 X2, ¬ old c X1 X2) (old_3 : (∀ X0 X1 X2, ¬ old X0 X1 X1 ∨ ¬ old X2 X1 X0 ∨ old X1 X2 X0)) (rule_def_0_0 : ∀ (X Y Z : G), a = X ∨ ¬sP0 X Y Z) (rule_def_0_1 : ∀ (X Y Z : G), b = Y ∨ ¬sP0 X Y Z) (rule_def_0_2 : ∀ (X Y Z : G), c = Z ∨ ¬sP0 X Y Z) (rule_def_1_0 : ∀ (X Y Z : G), a = X ∨ ¬sP1 X Y Z) (rule_def_1_1 : ∀ (X Y Z : G), c = Y ∨ ¬sP1 X Y Z) (rule_def_1_2 : ∀ (X Y Z : G), old Z a (sF0 X Y Z) ∨ ¬sP1 X Y Z) (new_imp : ∀ (X Y Z), ¬ new X Y Z ∨ old X Y Z ∨ sP0 X Y Z ∨ sP1 X Y Z) (imp_new_0 : ∀ (X Y Z), ¬ old X Y Z ∨ new X Y Z) : (∀ X0 X1 X2, ¬ new X0 X1 X1 ∨ ¬ new X2 X1 X0 ∨ new X1 X2 X0) := by
  ...
  have eq269 : (sP0 a sk1 sk1) ∨ (sP1 sk0 sk1 sk1) ∨ (old sk0 sk1 sk1) := Eq.mp (by grind only) eq106 -- backward demodulation 106,261
  have eq307 : a = c ∨ c = sk1 := Eq.mp (by grind only) eq211 -- backward demodulation 211,261
  have eq322 : (sP1 a sk1 sk1) ∨ (sP0 a sk1 sk1) ∨ (old sk0 sk1 sk1) := Eq.mp (by grind only) eq269 -- forward demodulation 269,261
  have eq323 : (old a sk1 sk1) ∨ (sP1 a sk1 sk1) ∨ (sP0 a sk1 sk1) := Eq.mp (by grind only) eq322 -- forward demodulation 322,261
  have eq359 : c = sk1 := resolve eq307 ac -- subsumption resolution 307,50
  have eq374 : (sP0 a c c) ∨ (old a sk1 sk1) ∨ (sP1 a sk1 sk1) := Eq.mp (by grind only) eq323 -- backward demodulation 323,359
  have eq397 : (old a c c) ∨ (sP0 a c c) ∨ (sP1 a sk1 sk1) := Eq.mp (by grind only) eq374 -- forward demodulation 374,359
  have eq398 : (sP0 a c c) ∨ (sP1 a sk1 sk1) := resolve eq397 p4XZ -- subsumption resolution 397,54
  have eq399 : (sP1 a c c) ∨ (sP0 a c c) := Eq.mp (by grind only) eq398 -- forward demodulation 398,359
...
theorem _root_.Equation707_not_implies_Equation1223 : ∃ (G : Type) (_ : Magma G), Equation707 G ∧ ¬Equation1223 G := by
  refine ⟨ℕ, PartialSolution.counter1223.toMagma,
    PartialSolution.counter1223.toMagma_equation707, ?_⟩
  have h1 := PartialSolution.counter1223.of_R 1 1 2 (by unfold PartialSolution.counter1223; decide)
  have h2 := PartialSolution.counter1223.of_R 1 2 1 (by unfold PartialSolution.counter1223; decide)
  have h3 := PartialSolution.counter1223.of_R 1 3 2 (by unfold PartialSolution.counter1223; decide)
  have h4 := PartialSolution.counter1223.of_R 1 4 3 (by unfold PartialSolution.counter1223; decide)
  have h5 := PartialSolution.counter1223.of_R 2 1 3 (by unfold PartialSolution.counter1223; decide)
  have h6 := PartialSolution.counter1223.of_R 2 3 1 (by unfold PartialSolution.counter1223; decide)
  have h7 := PartialSolution.counter1223.of_R 3 1 4 (by unfold PartialSolution.counter1223; decide)
  have h8 := PartialSolution.counter1223.of_R 3 4 1 (by unfold PartialSolution.counter1223; decide)
  intro h
  specialize h 1
  change 1 =
...
theorem _root_.Equation707_not_implies_Equation1316 : ∃ (G : Type) (_ : Magma G), Equation707 G ∧ ¬Equation1316 G := by
  refine ⟨ℕ, PartialSolution.counter1316.toMagma,
    PartialSolution.counter1316.toMagma_equation707, ?_⟩
  have h1 := PartialSolution.counter1316.of_R 1 1 1 (by unfold PartialSolution.counter1316; decide)
  have h2 := PartialSolution.counter1316.of_R 1 2 1 (by unfold PartialSolution.counter1316; decide)
  intro h
  specialize h 2 1
  change 2 =
    PartialSolution.counter1316.complFun 1 (PartialSolution.counter1316.complFun (PartialSolution.counter1316.complFun (PartialSolution.counter1316.complFun 1 2) 1) 1) at h
...
theorem _root_.Equation707_not_implies_Equation2238 : ∃ (G : Type) (_ : Magma G), Equation707 G ∧ ¬Equation2238 G := by
  refine ⟨ℕ, PartialSolution.counter2238.toMagma,
    PartialSolution.counter2238.toMagma_equation707, ?_⟩
  ...
  have h4 := PartialSolution.counter2238.of_R 2 3 1 (by unfold PartialSolution.counter2238; decide)
  intro h
  specialize h 1
  change 1 =
...
theorem _root_.Equation707_not_implies_Equation2847 : ∃ (G : Type) (_ : Magma G), Equation707 G ∧ ¬Equation2847 G := by
  refine ⟨ℕ, PartialSolution.counter2847.toMagma,
    PartialSolution.counter2847.toMagma_equation707, ?_⟩
  ...
  have h4 := PartialSolution.counter2847.of_R 2 3 1 (by unfold PartialSolution.counter2847; decide)
  intro h
  specialize h 1
  change 1 =
...
theorem _root_.Equation707_not_implies_Equation2940 : ∃ (G : Type) (_ : Magma G), Equation707 G ∧ ¬Equation2940 G := by
  refine ⟨ℕ, PartialSolution.counter2940.toMagma,
    PartialSolution.counter2940.toMagma_equation707, ?_⟩
  have h1 := PartialSolution.counter2940.of_R 1 1 1 (by unfold PartialSolution.counter2940; decide)
  have h2 := PartialSolution.counter2940.of_R 1 2 1 (by unfold PartialSolution.counter2940; decide)
  intro h
  specialize h 2 1
  change 2 =
    PartialSolution.counter2940.complFun (PartialSolution.counter2940.complFun (PartialSolution.counter2940.complFun 1 (PartialSolution.counter2940.complFun 1 2)) 1) 1 at h
  simp only [h1, h2] at h
  exact absurd h (by decide)
