...
theorem Equation5_implies_Equation8 (G: Type*) [Magma G] (h: Equation5 G) : Equation8 G := by
  intro x
  rw [<-h, <-h]
...
theorem Equation5_implies_Equation4512 (G: Type*) [Magma G] (h: Equation5 G) : Equation4512 G := by
  intro x y z
  rw [<-h, <-h, <-h]
