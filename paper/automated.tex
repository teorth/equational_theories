...
When the project started, contributors had varying degrees of knowledge of ATPs and utilisation skills, with several of us having to start using them from the ground up. With hindsight, several of the project computations could have been approached in better ways, their difficulty diminished due to better ATP expertise. Accordingly, in this section\footnote{Consult the ETP site for a substantially expanded version of these notes.} we provide some facts and hints about ATP usage, primarily with the algebraist working with (unsorted) equational theories in mind, based on our experience and available evidence\footnote{The timings presented here cannot be taken as benchmarks. Different experiments were executed on different machines, with heterogeneous software and OS environments (Ubuntu, Windows 10...), with varying numbers of parallel processes--both internal and external to the experiment--and, in many cases, under the Linux \Verb|nice| command.} within the ETP. We restrict our attention to \emph{Vampire} and \emph{Prover9}-\emph{Mace4}, as those have been the main tools used for exploration of implications and anti-implications along the ETP.
