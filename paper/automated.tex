...
\begin{table}
\centering
\caption{Time to find one model of $\Eq{677}$ of size 9 and to exhaust the same size for different configurations. Some finite-setting formulas were included to speed up the search (see \Cref{finite setting}). The configurations not listed here were unable to find a model in 4000s.}
