...
\begin{align}
    ...
    \x &\formaleq (\y \op (\x \op (\y \op \x))) \op \y \label{eq2301}\tag{E2301} \\
        ...
        \x &\formaleq \y \op ((((\x \op \x) \op \x) \op \z) \op (((\x \op \x) \op \y) \op \z)) \mspace{-45mu} & \hbox{(Group division)} \label{eq42302852}\tag{E42302852} \\
        \x &\formaleq \y \op ((((\y \op \y) \op \x) \op \z) \op (((\y \op \y) \op \y) \op \z)) \mspace{-45mu} & \hbox{(Group division)} \label{eq42323216}\tag{E42323216} \\
        \x &\formaleq (\y \op \y) \op (\y \op ((\x \op \z) \op (((\x \op \x) \op \y) \op \z))) \mspace{-45mu} & \hbox{(Finite group division)} \label{eq67953597}\tag{E67953597} \\
        \x &\formaleq ((\y \op \y) \op ((\x \op \z) \op \x)) \op ((\z \op \w) \op (\x \op \w)) \mspace{-45mu} & \hbox{(Group division)} \label{eq102744082}\tag{E102744082} \\
        \x &\formaleq ((\y \op \y) \op (\y \op (\x \op (((\y \op \y) \op \y) \op \z)))) \op \z \mspace{-45mu} & \hbox{(Group division)} \label{eq147976245}\tag{E147976245}
\end{align}
\endgroup
