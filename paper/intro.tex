...
\begin{itemize}
\item In the blueprint on the ETP web site, we report some partial progress on classifying which of the $57882$ distinct laws of order $5$ are equivalent to the singleton law $\Eq{2}$, either with or without the requirement that the magma be finite.
