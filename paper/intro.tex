...
Of the $\num{22033636}$ possible implications ${\E} \models {\E'}$, $8178279$ (or $37.12\%$) would end up being true; for an additional set of either $820$ or $822$ pairs $\E,{\E'}$, the weaker implication ${\E} \modelsfin {\E'}$ also held. To establish such positive implications ${\E} \models {\E'}$ or ${\E} \modelsfin {\E'}$, the main techniques used were as follows:
