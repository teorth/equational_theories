...
\begin{figure}
    ...
    \resizebox{\textwidth}{!}{%
      \begin{tikzpicture}
        \node(1)[draw] at (0,15) {$\x \formaleq \x$ (1)};
        \node(3253)[draw] at (4,14) {$\x \op \x \formaleq \x \op (\x \op (\x \op \x))$ (3253)};
        \node(3456)[draw] at (-4,14) {$\x \op \x \formaleq \x \op ((\x \op \x) \op \x)$ (3456)};
        \node(3319)[draw] at (7,13) {$\x \op \y \formaleq \x \op (\y \op (\y \op \y))$ (3319)};
        \node(307)[draw] at (1,13) {$\x \op \x \formaleq \x \op (\x \op \x)$ (307)};
        \node(3522)[draw] at (-5,13) {$\x \op \y \formaleq \x \op ((\y \op \y) \op \y)$ (3522)};
        \node(326)[draw] at (0,12) {$\x \op \y \formaleq \x \op (\y \op \y)$ (326)};
        \node(3715)[draw] at (0,11) {$\x \op \y \formaleq (\x \op \x) \op (\y \op \y)$ (3715)};
        \node(3)[draw] at (0,10) {$\x \formaleq \x \op \x$ (3)};
        \draw[dashed](3)--(-10,10);
        \draw[dashed](3)--(10,10);
        \node(412)[draw] at (0,9) {$\x \formaleq \x \op (\x \op (\x \op (\x \op \y)))$ (412)};
        \node(48)[draw] at (0,8) {$\x \formaleq \x \op (\x \op (\x \op \y))$ (48)};
        \node(618)[draw] at (3,7) {$\x \formaleq \x \op (\x \op ((\x \op \y) \op \z))$ (618)};
        \node(418)[draw] at (-3,7) {$\x \formaleq \x \op (\x \op (\y \op (\x \op \z)))$ (418)};
        \node(9)[draw] at (0,6) {$\x \formaleq \x \op (\x \op \y)$ (9)};
        \node(824)[draw] at (-9.7,5) {$\x \formaleq \x \op ((\x \op \y) \op (\x \op \z))$ (824)};
        \node(829)[draw] at (-3.1,5) {$\x \formaleq \x \op ((\x \op \y) \op (\z \op \y))$ (829)};
        \node(1027)[draw] at (3.1,5) {$\x \formaleq \x \op ((\x \op (\y \op \x)) \op \z)$ (1027)};
        \node(1033)[draw] at (9.7,5) {$\x \formaleq \x \op ((\x \op (\y \op \z)) \op \z)$ (1033)};
        \node(103)[draw] at (0,4) {$\x \formaleq \x \op ((\x \op \y) \op \z)$ (103)};
        \node(1235)[draw] at (-9,4) {$\x \formaleq \x \op (((\x \op \y) \op \z) \op \y)$ (1235)};
        \node(1237)[draw] at (0,3) {$\x \formaleq \x \op (((\x \op \y) \op \z) \op \w)$ (1237)};
        \node(1037)[draw] at (0,2) {$\x \formaleq \x \op ((\y \op (\x \op \x)) \op \z)$ (1037)};
        \node(4)[draw] at (0,1) {$\x \formaleq \x \op \y$ (4)};
        \node(2)[draw] at (0,0) {$\x \formaleq \y$ (2)};
        \draw(2)--(4);
        \draw(4)--(1037);
        \draw(1037)--(1237);
        \draw(1237)--(1235);
