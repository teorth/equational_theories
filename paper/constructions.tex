...
\begin{remark}  The construction in \Cref{trans-nonab}
\end{remark}
...
Discuss the greedy method in both translation-invariant and non-translation-invariant settings.  Mention how ATPs and other automated techniques play an important role, as human-generated case analysis here can be quite error-prone.
