...
By performing brute force over all magmas up to size $4$, a total of $\num{13753982}$ implications ($62.4\%$ of all implications, and $99.3\%$ of the false ones) can be refuted with $523$ distinct magmas. Of these implications, $\num{13596121}$ were refuted with magmas of size\footnote{For an earlier computer exploration of size $3$ magmas, see \cite{berman-burris}.} at most $3$, with the remaining $\num{157861}$ requiring magmas of size $4$. Performing this search took 165 CPU-hours.
