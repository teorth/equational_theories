...
Combining several of these techniques allowed us to find refutations for \eqref{eq854} $\nvdashfin$ \eqref{eq413}, \eqref{eq1045}, \eqref{eq1055},
\eqref{eq3316}, \eqref{eq3925}.  We started with a magma which satisfied \eqref{eq854} and \eqref{eq413} but had an \eqref{eq10} violation.
After using it as a seed to generate larger magmas with more \eqref{eq10} violations (using Vampire),
