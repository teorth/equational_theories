...
\response{\done\ The introduction now names the Liquid Tensor Experiment first among the Lean
formalization projects that the ETP built on, ahead of PFR, and states that the ETP's
experience confirms the previous experiences with such structures. We have also recorded
the principal difference the referee asks about. In the LTE and in PFR the blueprint was
the centralized source of project objectives; in the ETP it was not, being used instead to
organize the formalization of a few selected implications and to record observations made
informally, with the objectives themselves carried by Zulip discussion and by the GitHub
issue tracker. This, together with the modularity of the goal discussed in \textbf{R1.14},
is what allowed the ETP to decentralize further than its predecessors, and to do so before
any blueprint had been written.}
