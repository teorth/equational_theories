...
> [!WARNING]
> Before pushing any changes, you have the following options to reduce the risk of CI check failures:
>
...
>   ```
>   This will automatically run checks before every push.
>
> - Alternatively, you can manually run the following script before pushing:
>
>   ```bash
...
>
> - You may push your changes without any safeguard, but this increases the risk of CI check failures.
