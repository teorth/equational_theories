This law is equivalent to [law 4505](https://teorth.github.io/equational_theories/implications/?4505), which states that all products `x ◇ (y ◇ y)` and `(_ ◇ _) ◇ _` are equal to the same element `∞`.
