This law is equivalent to stating that all products of the form `(_ ◇ _) ◇ _` and all those of the form `x ◇ (x ◇ _)` are equal to the same element `e`, which is a left and right zero `e◇x = x◇e = e`.
