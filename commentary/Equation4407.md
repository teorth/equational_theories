This law is equivalent to [law 4431](https://teorth.github.io/equational_theories/implications/?4431), which states that all products of the form `(_ ◇ _) ◇ _` and all those of the form `x ◇ (x ◇ _)` are equal.
