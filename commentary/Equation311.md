Magmas satisfying this law are characterized by the subset `P = {x◇y|x,y∈M}`, the operation restricted to `◇: M × M∖P → P`, and the restriction of the squaring map to `S: P → P`.
