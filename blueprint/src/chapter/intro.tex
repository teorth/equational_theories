...
\begin{definition}[Equation 374794]\label{eq374794}\uses{magma-def}  Equation 374794 is the law $x=x$.
...
\begin{theorem}[Kisielewicz theorem]\label{kis-thm}\uses{eq374794}  Definition \ref{eq374794} has an infinite model, but no non-trivial finite model.
\end{theorem}
