...
\begin{definition}[Equation 28394]
  \label{eq28394}\uses{magma-def}\lean{Equation28394}\leanok
  Equation 28394 is the law $0  \formaleq  (((1 \op 1) \op 1) \op 0) \op (1 \op 2)$ (or the equation $x = (((y \op y) \op y) \op x) \op (y \op z)$).
\end{definition}
...
\begin{theorem}[Kisielewicz's second Austin law]\label{kis-thm2}\uses{eq2, eq28394} \Cref{eq28394} is an Austin law.
\end{theorem}
