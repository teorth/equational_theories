...
\begin{theorem}[Kisielewicz's first Austin law]
  ...
  \Equaref{374794} is an Austin law.
\end{theorem}
...
\begin{theorem}[Kisielewicz's second Austin law]\label{kis-thm2}\uses{eq2, eq28770}\lean{InfModel.Finite.Equation28770_implies_Equation2}\lean{InfModel.Equation28770_not_implies_Equation2}\leanok \Equaref{28770} is an Austin law.
\end{theorem}
...
An open question is whether \Equaref{5093} is an Austin law.  We have the following partial result from \cite{Kisielewicz2}:
...
\begin{theorem}[3994 implies 3588 for finite models]\label{finite_imp_3994_3588_thm}\uses{eq3994,eq3588,models-def}
  ...
  All finite magmas which satisfy \Equaref{3994} also satisfy \Equaref{3588}.
\end{theorem}
