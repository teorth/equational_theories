...
\begin{lemma}[1722 extension]\label{1722-extension}\leanok\lean{Eq1722.Greedy2.lift}  Suppose that $\op$ is a partial solution, and $a \op b$ is currently undefined.  Then there exists an extension $\op'$ of $\op$ for which $a \op' b$ is defined.
\end{lemma}
...
\begin{lemma}[1076 extension]\label{1076-extension}  Suppose that $\op$ is a partial solution, and $a \op b$ is currently undefined.  Then there exists an extension $\op'$ of $\op$ for which $a \op' b$ is defined.
\end{lemma}
\begin{proof}
