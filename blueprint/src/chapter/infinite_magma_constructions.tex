...
(\Equaref{65}), reviewed in \Cref{asterix-section}.
...
The implication between the laws \Equaref{1648} and \Equaref{206} can be refuted by a translation-invariant
...
A model refuting the implication between the laws \Equaref{1659} and \Equaref{4315} can be constructed using
...
Now we consider the Dupont equation, \Equaref{63}, which can be treated by a greedy translation invariant construction that is more complicated than the one considered for the Asterix law in \Cref{asterix-section}.
