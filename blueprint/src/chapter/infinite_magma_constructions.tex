...
\begin{lemma}[1289 extension]\label{1289-extension}\leanok\lean{Eq1076.Greedy.lift}  Suppose that $\op$ is a partial solution, and $a \op b$ is currently undefined.  Then there exists an extension $\op'$ of $\op$ for which $a \op' b$ is defined.
\end{lemma}
