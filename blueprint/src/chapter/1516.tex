...
Define a \emph{seed} to be an injective partial function $L_x$ defined on finitely many values and obeying \Cref{axioma-again}, as well as \Cref{axiomb-again} whenever $L_x L_x y$ is defined.
