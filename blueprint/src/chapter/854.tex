...
\begin{corollary}[854 does not not imply 413]  There is an 854 magma which does not obey the 413 law $x = x \op (x \op (x \op (y \op x)))$.
\end{corollary}
...
\begin{corollary}[854 does not not imply 1045]  There is an 854 magma which does not obey the 1045 law $x = x \op ((y \op (y \op x)) \op x)$.
\end{corollary}
