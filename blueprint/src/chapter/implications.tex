...
\begin{theorem}[29 equivalent to 14]\label{29_equiv_14} \uses{eq29,eq14}\lean{Subgraph.Equation29_implies_Equation14, Subgraph.Equation14_implies_Equation29}\leanok  Definition \ref{eq29} is equivalent to Definition \ref{eq14}.
\end{theorem}
