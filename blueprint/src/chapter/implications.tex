...
\begin{theorem}[29 equivalent to 14]\label{29_equiv_14} \uses{eq29,eq14}\lean{Subgraph.Equation29_implies_Equation14}\leanok  \Equareffull{29} is equivalent to \Equareffull{14}.
\end{theorem}
...
\begin{theorem}[3744 implies 3722, 381]\label{3744_implies_3722_381}\uses{eq3744, eq3722, eq381}\lean{Subgraph.Equation3744_implies_Equation3722, Subgraph.Equation3744_implies_Equation381}\leanok \Equareffull{3744} implies \Equareffull{3722} and \Equareffull{381}.
\end{theorem}
...
\begin{theorem}[1689 is equivalent to 2]\label{1689_equiv_2}\uses{eq1689, eq2}\lean{Subgraph.Equation1689_implies_Equation2, Subgraph.Equation2_implies_Equation1689}\leanok \Equareffull{1689} is equivalent to \Equaref{2}.
\end{theorem}
...
\begin{theorem}[Consequences of 1571]\label{1571_impl}\uses{eq1571, eq2662, eq40, eq23, eq8, eq16, eq14, eq43, eq4512}\lean{Subgraph.Equation1571_implies_Equation2662, Subgraph.Equation1571_implies_Equation40, Subgraph.Equation1571_implies_Equation23,Subgraph.Equation1571_implies_Equation8, Subgraph.Equation1571_implies_Equation16, Subgraph.Equation1571_implies_Equation43, Subgraph.Equation1571_implies_Equation4512}\leanok  Magmas satisfying \Equareffull{1571} also satisfy \Equaref{2662}, \Equaref{40}, \Equaref{23}, \Equaref{8}, \Equaref{16}, \Equaref{14}, \Equaref{43}, and \Equaref{4512}, and are in fact abelian groups of exponent two.  Conversely, all abelian groups of exponent two satisfy \Equaref{1571}.
\end{theorem}

\begin{proof}\leanok  Suppose that a magma $G$ satisfies \Equaref{1571}, thus
...
\begin{theorem}[953 is equivalent to 2]\label{953_equiv_2}\uses{eq953, eq2}\lean{Subgraph.Equation953_implies_Equation2}\leanok  \Equareffull{953} is equivalent to \Equaref{2}.
\end{theorem}
...
\begin{theorem}[Sheffer stroke axiom]\label{sheffer}\uses{eq345169}\lean{Sheffer.Equation345169_is_Boolean}\leanok  Definition \Equareffull{345169}
...
$$ (a,b) \op (c,d) = (b,c).$$
These are examples of central groupoids, \Equareffull{168}.

\begin{theorem}[Natural central groupoid axiom]\label{natural-central-groupoid}\uses{eq26302} \Equareffull{26302} characterizes natural central groupoids.
\end{theorem}

\begin{proof}
  See \cite[Theorem 5]{knuth}.  The proof is quite lengthy; a sketch is as follows. It is easy to see that natural central groupoids satisfy \Equaref{26302}.  Conversely, if this law holds, then
\begin{align*}
