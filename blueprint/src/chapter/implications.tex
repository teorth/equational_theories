...
\begin{theorem}[387 implies 43]\label{387_implies_43}  Definition \ref{eq387} implies Definition \ref{eq43}.
\end{theorem}

\begin{proof} (From \url{MathOverflow}{https://mathoverflow.net/a/450905/766}).
