...
\begin{definition}[Equation 16]\label{eq16}\lean{Equation16}\leanok\uses{magma-def}  Equation 16 is the law $0 \formaleq  1 \circ (1 \circ 0)$ (or the equation $x = y ∘ (y ∘ x))$.
\end{definition}
