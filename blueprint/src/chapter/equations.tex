...
This is the right absorption law (the dual of \Equaref*{4}).
...
\Equadef{23}{x = (x \op x) \op x}
\end{definition}

This is the dual of \Equaref*{8}.
...
\Equadef{29}{x = (y \op x) \op y)}
\end{definition}

Appears in Problem A1 from Putnam 2001.  Dual to \Equaref*{14}.  See \Cref{29_equiv_14}.
...
\Equadef{39}{x \op x = y \op x}
\end{definition}

This law asserts that the magma operation is independent of the first argument (the dual of \Equaref*{38}).
...
\Equadef{41}{x \op x = y \op z}
\end{definition}

This law is equivalent to the constant law, \Equaref*{46}.
...
\Equadef{42}{x \op y = x \op z}
\end{definition}

Equivalent to \Equaref*{38}.
...
\Equadef{45}{x \op y = z \op y}
\end{definition}

This is the dual of \Equaref*{42}.
...
\Equadef{168}{x = (y \op x) \op (x \op z)}
\end{definition}
...
\Equadef{206}{x = (x \op (x \op y)) \op y}
\end{definition}
...
\Equadef{381}{x \op y = (x \op z) \op y}
\end{definition}
...
\Equadef{387}{x \op y = (y \op y) \op x}
\end{definition}
...
\Equadef{477}{x = y \op (x \op (y \op (y \op y)))}
\end{definition}
...
\Equadef{854}{x = x \op ((y \op z) \op (x \op z))}
\end{definition}
...
\Equadef{953}{x = y \op ((z \op x) \op (z \op z))}
\end{definition}
...
\Equadef{1485}{x = (y \op x) \op (x \op (z \op y))}
\end{definition}

The weak central groupoid law, implied by the central groupoid law \Equaref*{168}. Studied in \Cref{weak-central-groupoids-chapter}.
...
\Equadef{1491}{x = (y \op x) \op (y \op (y \op x))}
\end{definition}
...
\Equadef{1571}{x = (y \op z) \op (y \op (x \op z))}
\end{definition}
...
\Equadef{1648}{x = (x \op y) \op ((x \op y) \op y)}
\end{definition}
...
\Equadef{1657}{x = (x \op y) \op ((y \op y) \op x)}
\end{definition}
...
\Equadef{1659}{x = (x \op y) \op ((y \op y) \op z)}
\end{definition}
...
\Equadef{1661}{x = (x \op y) \op ((y \op z) \op y)}
\end{definition}
...
\Equadef{1689}{x = (y \op x) \op ((x \op z) \op z)}
\end{definition}
...
\Equadef{1701}{x = (y \op x) \op ((z \op x) \op x)}
\end{definition}
...
\Equadef{2662}{x = ((x \op y) \op (x \op y)) \op x}
\end{definition}
...
\Equadef{3167}{x = (((y \op y) \op z) \op z) \op x}
\end{definition}
...
\Equadef{3588}{x \op y = z \op ((x \op y) \op z)}
\end{definition}
...
\Equadef{3722}{x \op y = (x \op y) \op (x \op y)}
\end{definition}
...
\Equadef{3744}{x \op y = (x \op z) \op (w \op y)}
\end{definition}
...
\Equadef{3994}{x \op y = (z \op (x \op y)) \op z}
\end{definition}
...
\Equadef{4315}{x \op (y \op x) = x \op (y \op z)}
\end{definition}
...
\Equadef{4512}{x \op (y \op z) = (x \op y) \op z}
\end{definition}
...
\Equadef{4513}{x \op (y \op z) = (x \op y) \op w}
\end{definition}
...
\Equadef{4522}{x \op (y \op z) = (x \op w) \op u}
\end{definition}

Dual to \Equaref*{4579}.
...
\Equadef{4564}{x \op (y \op z) = (w \op y) \op z}
\end{definition}

Dual to \Equaref*{4513}.
...
\Equadef{4579}{x \op (y \op z) = (w \op u) \op z}
\end{definition}

Dual to \Equaref*{4522}.
...
\Equadef{4582}{x \op (y \op z) = (w \op u) \op v}
\end{definition}
...
\Equadef{5093}{x = y \op (y \op (y \op (x \op (z \op y))))}
\end{definition}
...
\Equadef{26302}{x = (y \op ((z \op x) \op w)) \op (x \op w)}
\end{definition}
...
\Equadef{28770}{x = (((y \op y) \op y) \op x) \op (y \op z)}
\end{definition}
...
\Equadef{345169}{x = (y \op ((x \op y) \op y)) \op (x \op (z \op y))}
\end{definition}
...
\Equadef{374794}{x = (((y \op y) \op y) \op x) \op ((y \op y) \op z)}
\end{definition}
