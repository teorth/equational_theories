...
\begin{definition}[Equation 4378]\label{eq4378}\lean{Equation4378}\leanok\uses{magma-def}  Equation 4378 is the law $x \circ (y \circ z) = w \circ (u \circ z)$.
\end{definition}
