...
![Hasse diagram of selected equations](images/subgraph.png)
...
For guidelines on how to contribute, see the [CONTRIBUTING.md](CONTRIBUTING.md) file.  Participants are requested to abide by [our code of conduct](CODE_OF_CONDUCT.md).
...
- Oct 6, 2024: Current dashboard status (fixing an accounting error in previous dashboards): 31019 explicitly proven, 8147260 implicitly proven, 582094 explicitly disproven, 13272262 implicitly disproven, 1001 open (99.995% complete). Only [16 implications needed](data/outstanding_3op_implications.txt) to resolve the graph for laws of length 3, and [696 to resolve the entire graph](data/unknowns_10_06.txt) (including 36 conjectured to be false by Vampire, marked with an asterisk)!
